...
namespace InfimaGames.LowPolyShooterPack
{
	...
	public sealed class Character : CharacterBehaviour
	{
		...
		protected override void Awake()
		{
			...
			// Register self with ServiceLocator BEFORE inventory.Init().
			// Weapon.Awake() (triggered by Init) calls GetPlayerCharacter() —
			// we must already be registered so weapons find the correct Character.
			var gameModeService = ServiceLocator.Current.Get<IGameModeService>();
			gameModeService?.RegisterPlayerCharacter(this);
